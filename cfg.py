...
inference_cfg = Bunch(
    ...
    load_checkpoint = 'checkpoints/2023-May-05-08:17:01/E200.pytorch',    #The path to the directory where PTB data is stored, and auxiliary data files will be stored.
    num_samples = 10,         #生成的新数据量
